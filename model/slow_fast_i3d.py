...
class SlowFastI3D(nn.Module):
    def __init__(self, input_channels, a, b, number_classes, reshape_method='time_to_channel', endpoint='feature',
        ...
        self.slow_end_points = nn.ModuleDict(
            {
                ...
                'Mixed_4b': InceptionModule((128 + 192 + 96 + 64) * self.extra_channel_coefficient,
                                            [192, 96, 208, 16, 48, 64], debug=self.inception_inner_debug),
                ...
                'Mixed_5b': InceptionModule((256 + 320 + 128 + 128) * self.extra_channel_coefficient,
                                            [256, 160, 320, 32, 128, 128], debug=self.inception_inner_debug),
        ...
        self.classify_head = nn.LazyLinear(self._number_classes)
